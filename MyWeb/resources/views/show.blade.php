...
<div class="col-md-4">
    <div class="card" style="width: 800px">
        @foreach($posts as $post)
            <img class="card-img-top" img src="http://via.placeholder.com/800x500?text={{$post->author}} "/>
            <div class="card-body">
                        ...
                        <form id="comment-form" method="post" action="{{ route('comments.store') }}" >
                            ...
                            <div class="row" style="padding: 10px;">
                                <div class="form-group">
                                    <textarea class="form-control" name="comment" placeholder="Add a coomment..."></textarea>
                                </div>
                            </div>
